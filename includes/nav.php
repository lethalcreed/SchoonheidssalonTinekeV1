<!--Unused fb code(Might be used later)-->
<div id="fb-root"></div>
...
<!--            The dropdown menu for the account. Here is also the login script-->
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Account</a>
                <ul class="dropdown-menu dropdown-user">
                    <li>
<!--                        If the user is rank 1 and logged in this wil be displayed-->
...
//                    if the user is rank 3 this wil be displayed
                    ...
                    <?php }
//                    if the user is not logged in the login screen wil be shown
                    } else { ?>
                        <div>
                    ...
                    <?php }
//                    here are all the checks done for the passwords and usernames
